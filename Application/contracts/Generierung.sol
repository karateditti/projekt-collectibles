...
contract Generierung is Eigentumsdefinition{
    ...
    function singlepoint_crossover(uint id_1, uint id_2) public view returns(FraktalErscheinung memory){
        ...
        FraktalErscheinung memory erscheinung = FraktalErscheinung(kind[0],kind[1],kind[2],kind[3],kind[4],kind[5],Farbe(kind[6],kind[7],kind[8]),kind[9],kind[10]);
        return erscheinung;


    }

    function combine(uint id_1, uint id_2) public returns(uint){
